...
pub(super) fn synthesize_type_annotation<S: ContextType, T: crate::FSResolver>(
    ...
    let ty = match annotation {
        TypeAnnotation::StringLiteral(value, _) => checking_data
            .types
        ...
        TypeAnnotation::BooleanLiteral(value, _) => checking_data
            .types
            .new_constant_type(Constant::Boolean(value.clone())),
        ...
        TypeAnnotation::ObjectLiteral(members, _) => {
            ...
            let onto = checking_data.types.register_type(Type::Object(
                crate::types::ObjectNature::AnonymousTypeAnnotation,
            ));
    ...
    checking_data
        .type_mappings
        .types_to_types
        .push(annotation.get_position().into_owned(), ty);
