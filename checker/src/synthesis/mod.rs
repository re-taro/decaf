...
pub struct DecafParser;

impl crate::ASTImplementation for DecafParser {
        ...
        match for_loop_initialiser {
            parser::statements::ForLoopStatementInitialiser::VariableDeclaration(declaration) => {
                ...
                synthesise_variable_declaration(
                    ...
                    checking_data
                        .options
                        .infer_sensible_constraints_in_for_loops,
                );
            }
...
>(
    ...
    environment: &mut Environment,
    checking_data: &mut CheckingData<T, DecafParser>,
