...
pub(crate) fn synthesise_jsx_element<T: crate::ReadFromFS>(
    ...
    let tag_name_as_cst_ty = checking_data
        .types
        .new_constant_type(Constant::String(element.tag_name.clone()));
    ...
    let jsx_function =
        if let Ok(ty) = environment.get_variable_handle_error(JSX_NAME, position, checking_data) {
            ...
            checking_data
                ...
                .add_error(TypeCheckError::CouldNotFindVariable {
                    variable: JSX_NAME,
...
fn synthesise_jsx_child<T: crate::ReadFromFS>(
    ...
    match child {
        ...
        JSXNode::TextNode(text, _) => checking_data
            .types
            .new_constant_type(Constant::String(text.clone())),
...
fn synthesise_attribute<T: crate::ReadFromFS>(
    ...
    let (key, value) = match attribute {
        ...
        JSXAttribute::Static(name, value, _attribute_id) => (
            ...
            checking_data
                .types
                .new_constant_type(crate::Constant::String(value.clone())),
        ),
        ...
        JSXAttribute::Spread(_, pos) => {
            ...
            return (
                PropertyKey::String(Cow::Borrowed("err")),
                TypeId::UNIMPLEMENTED_ERROR_TYPE,
            );
        }
