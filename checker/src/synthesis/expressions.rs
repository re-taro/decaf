...
pub(super) fn synthesise_expression<T: crate::ReadFromFS>(
    ...
    let instance: Instance = match expression {
        ...
        Expression::NumberLiteral(value, ..) => {
            ...
            return checking_data
                .types
                .new_constant_type(Constant::Number(not_nan));
        }
        ...
        Expression::TemplateLiteral(TemplateLiteral {
            ...
            Instance::RValue(synthesise_template_literal_expression::<_, DecafParser>(
                tag,
        ...
        Expression::BinaryAssignmentOperation {
            lhs,
            operator,
            rhs,
            position,
        ...
        Expression::PropertyAccess {
            ...
            if *is_optional {
                ...
                Instance::RValue(new_conditional_context(
                    ...
                    |_env: &mut Environment, _data: &mut CheckingData<T, DecafParser>| {
        ...
        Expression::ThisReference(pos) => Instance::RValue(environment.get_value_of_this(
            &checking_data.types,
            ...
            SpecialOperators::In { lhs, rhs } => {
                let (publicity, key) = match lhs {
                    ...
                    parser::expressions::InExpressionLHS::Expression(lhs) => {
                        ...
                        (
                            Publicity::Public,
                            PropertyKey::from_type(key, &checking_data.types),
                        )
                    }
                };
        ...
        Expression::IsExpression(is_expr) => Instance::RValue(synthesise_is_expression(
            is_expr,
            environment,
            checking_data,
        )),
    ...
    let arguments = arguments
        .map(|arguments| {
            arguments
                .iter()
                .map(|a| match a {
                    FunctionArgument::Spread(e, _) => UnsynthesisedArgument {
                        spread: true,
                        expression: e,
                    },
                    FunctionArgument::Standard(e) => UnsynthesisedArgument {
                        spread: false,
                        expression: e,
                    },
                    FunctionArgument::Comment { .. } => UnsynthesisedArgument {
                        spread: false,
                        expression: &comment,
                    },
                })
