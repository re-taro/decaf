        ...
        match item {
            StatementOrDeclaration::Declaration(declaration) => match declaration {
                ...
                Declaration::Function(function) => {
                    ...
                    let r#type = checking_data
                        .types
                        .new_type(Type::Function(function_type, constructor));

                    let VariableIdentifier::Standard(name, variable_id, name_position) =
                        &function.on.name
                    else {
                        todo!()
                    };
