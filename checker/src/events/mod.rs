    ...
    match event {
        ...
        Event::SetsVariable(variable, value) => {
...

            {
                ...
                facts
                    .events
                    .push(Event::SetsVariable(variable.clone(), new_value));
        ...
        Event::Setter {
            ...
            if initialization {
                target
                    ...
                    .register_property(on, under, new, true);
            } else {
        ...
        Event::Throw(thrown) => {
            let specialized_thrown = specialize(
                thrown,
                type_arguments,
                &environment.into_general_context(),
                types,
            ...
            target
                .get_top_level_facts(environment)
                .throw_value(specialized_thrown);
        ...
        Event::Return { returned } => {
            let specialized_returned = specialize(
                returned,
                type_arguments,
                &environment.into_general_context(),
                types,
        ...
        Event::CreateObject {
            ...
            let new_id =
                target
                    .get_top_level_facts(environment)
                    .new_object(prototype, types, is_under_dyn);
