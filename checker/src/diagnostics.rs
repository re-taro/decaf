...
impl DiagnosticsContainer {
    ...
    pub fn sources(&self) -> impl Iterator<Item = SourceId> + '_ {
        self.diagnostics
            .iter()
            .flat_map(diagnostics::Diagnostic::sources)
    }
...
impl TypeStringRepresentation {
    ...
    pub(crate) fn from_property_constraint(
        ...
        match property_constraint {
            ...
            crate::types::logical::Logical::Or {
                condition,
                left,
                right,
            } => {
...
impl From<NoEnvironmentSpecified> for Diagnostic {
    fn from(_error: NoEnvironmentSpecified) -> Self {
        Diagnostic::Global {
            reason: "No environment".to_owned(),
    ...
    fn from(warning: TypeCheckWarning) -> Self {
        ...
        match warning {
            ...
            TypeCheckWarning::ExcessProperty {
                ...
                reason: format!("'{excess_property_name}' is not a property of {expected_type}"),
                position,
                kind,
            },
            ...
            TypeCheckWarning::Unimplemented { item, position } => Diagnostic::Position {
            ...
            TypeCheckWarning::DisjointEquality {
                lhs,
                rhs,
                position,
                result,
