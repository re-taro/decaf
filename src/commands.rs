...
use crate::error_handling::emit_decaf_diagnostic;
...
pub(crate) fn check<T: crate::FSResolver>(
    ...
    let module = match module {
        ...
        Err(error) => {
            ...
            emit_decaf_diagnostic(error.into(), &fs, source_id).unwrap();
            return;
        }
    };
    ...
    for diagnostic in diagnostics.into_iter() {
        emit_decaf_diagnostic(diagnostic, &fs, module.source).unwrap();
    }
