            ...
            _ => {
                ...
                let initialiser =
                        ...
                        peek
                    {
                        ...
                        Some(ForLoopStatementInitialiser::VariableDeclaration(
                            declaration,
                        ))
                ...
                let start = initialiser
                    .as_ref()
                    .map_or(semi_colon_one, |init| match init {
...
mod tests {
    ...
    fn for_await() {
        assert_matches_ast!(
            ...
            ForLoopStatement {
                condition: ForLoopCondition::ForOf { is_await: true, .. },
                ..
            }
        );
        assert_matches_ast!(
            "for (let k of x) {}",
            ForLoopStatement {
                condition: ForLoopCondition::ForOf {
                    is_await: false,
                    ..
                },
                ..
